    ...
    <div class="col-xl-6">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form id="kt_ecommerce_settings_general_form" class="form" action="{{route('detachPackages')}}" method="post">
                    @csrf
                    {{--                    @method('PUT')--}}
                    <!--begin::Input group-->
                    <!--end::Input group-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" name="package_id" placeholder="enta1b2c3d4e"  />
