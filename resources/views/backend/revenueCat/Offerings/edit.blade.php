    ...
    <div class="col-xl-6">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form id="kt_ecommerce_settings_general_form" class="form" action="{{route('updateOfferings',$items->id)}}" method="post">
                    @csrf
                    {{--                    @method('PUT')--}}
                    <!--begin::Input group-->
                    <!--end::Input group-->
                    ...
                    <div class="fv-row mb-7">
                        <!--begin::Label-->
                        <label class="fs-6 fw-semibold form-label mt-3">
                            <span class="required">Is Current</span>
                            <span class="ms-1" data-bs-toggle="tooltip" title="Enter the contact's name.">
															<i class="ki-duotone ki-information fs-7">
																<span class="path1"></span>
																<span class="path2"></span>
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" name="is_current" value="{{$items->is_current}}" />
