                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h6>
                                                @php
                                                    $nu = \App\User::find($notes->user_id);
                                                @endphp

                                                {{isset($nu) ? $nu->name : 'User Deleted'}}
                                                ...
                                                <a id="delete" href="{{route('moderator.deleteNote',$notes->id)}}">
        ...
        <div class="col-md-4" id="messages" style="height: 90vh;overflow: scroll;background-color: #c0c0c0;">
            @foreach($cus_messages as $customer_history)
                @if($customer_history->id == $messages->id)
                    ...
                    @if(isset($customer_history->astrologerQuery) && $customer_history->astrologerQuery->revertedQuery->count() != 0)
                        <input type="hidden" name="reverted_id" value="{{($customer_history->astrologerQuery->revertedQuery->last())->id}}">
...
{{--                                @endif--}}
                                ...
                                <div class="widget widget-card-one"  style="background-color: #f3eede;@if($customer_history->id == $messages->id)border-color: #e6ab05;
                                    ...
                                    <div class="widget-content">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6>a. {{\App\User::find($customer_history->astrologerQuery->astrologer_id)->name}}
                                                    <a onclick="pinmessage('{{$customer_history->astrologerQuery->id}}',{{$customer_history->astrologerQuery->astrologer_id}},'astroans')">
                                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 122.879 122.867" enable-background="new 0 0 122.879 122.867" xml:space="preserve"><g><path fill-rule="evenodd" clip-rule="evenodd" d="M83.88,0.451L122.427,39c0.603,0.601,0.603,1.585,0,2.188l-13.128,13.125 c-0.602,0.604-1.586,0.604-2.187,0l-3.732-3.73l-17.303,17.3c3.882,14.621,0.095,30.857-11.37,42.32 c-0.266,0.268-0.535,0.529-0.808,0.787c-1.004,0.955-0.843,0.949-1.813-0.021L47.597,86.48L0,122.867l36.399-47.584L11.874,50.76 c-0.978-0.98-0.896-0.826,0.066-1.837c0.24-0.251,0.485-0.503,0.734-0.753C24.137,36.707,40.376,32.917,54.996,36.8l17.301-17.3 l-3.733-3.732c-0.601-0.601-0.601-1.585,0-2.188L81.691,0.451C82.295-0.15,83.279-0.15,83.88,0.451L83.88,0.451z"/></g></svg>
                                                    </a>
                                                </h6>
                            ...
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        @endif
                                        <h6>
                                            m. {{\App\User::find($customer_history->astrologerQuery->moderator_id)->name}}
            ...
            <div class="col-md-8 sticky-top" style="height: 90vh;padding: 0px;">
...
{{--                               @if($customer->details->is_time_accurate == 1 ) <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7ed321" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg> @else <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#d0021b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"></line></svg> @endif--}}
                       ...
                       @if(isset($similar_customers))
                       <div class="col-md-12">
                           <p style="font-weight: bold" >Similar Account Id's: @foreach($similar_customers as $similarCus) {{$similarCus->id}},  @endforeach </p>
                       </div>
                       @endif
                       <div class="col-md-12">
...
{{--                                               <p>30-Jun 23 06:52</p>--}}
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="padding: 0px;">
            <div class="widget " style="padding: 5px 5px 20px 5px; ">


            <div class="widget-content">
               <div class="row">
                   <div class="col-md-12" style="height: 30vh;padding-bottom: 10px;">
                       <textarea style="width: 100%; height: 100%; border-radius: 10px; padding: 20px;" id="messageArea"  placeholder="Write Reply"></textarea>
                       <div id="the-count">
            ...
            <div class="widget-content">
               <div class="col-md-12">
                   <div class="row">
                       ...
                       @if(isset( $messages->astrologerQuery->astrologer_id))
                       <div class="col-md-2 mt-2 mb-2" style="display: block;" id="answerToCustomerArea">

                           <button style="width: 100%;"  type="button"  class="btn btn-primary" id="answerPreviewButton">Answer</button>
                       </div>
                       @endif

                       <div class="col-md-2 mt-2 mb-2" id="clarifyBtnArea" style="display:none;">

                           <button style="width: 100%;"  type="button"  class="btn btn-primary" id="clarifyBtn" >Clarify</button>
                       </div>

                       <div class="col-md-2 mt-2 mb-2  @if(!isset( $messages->astrologerQuery->astrologer_id))  @endif">
                           <button style="width: 100%;" class="btn btn-info" data-toggle="modal" data-target="#sampleQuestionModal">Templates...</button>
                       </div>
                           @if(( $messages->read == 3))
                               <div class="col-md-3 mt-2 mb-2" style="display: block;" id="answerToCustomerArea">

                                   <button style="width: 100%;"  type="button"  class="btn btn-success" id="backToAstrologer">Back To Astrologer</button>
                               </div>

                           @else
                               <div class="col-md-2 mt-2 mb-2" id="sendToAstrologerArea" style="display: block;">
                                   <button style="width: 100%;"  type="button" class="btn btn-success mb-2 mr-2" id="sendToAstrologer" >To Astrologer</button>
                               </div>

                           @endif

                           @if(!isset($messages->astrologerQuery->astrologer_answer))
                           <div class="col-md-2 mt-2 mb-2" id="answerAsPyschologistArea" style="display: block;">

                               <button style="width: 100%;"  type="button"  class="btn btn-primary" id="answerAsPyschologist" >Answer as P.</button>
                           </div>
                           @endif
                           <div class="col-md-2 mt-2 mb-2">
                               <a style="width: 100%;" href="{{URL('moderator/postpone/'.$messages->id)}}"  type="button" class="btn btn-danger mb-2 mr-2" >Postpone</a>
                           </div>
                           <div class="col-md-2 mt-2 mb-2" id="cancelBtnArea" style="display: none;">

                               <button style="width: 100%;"  type="button"  class="btn btn-danger" id="cancelBtn" >Cancel</button>
                           </div>
{{--                       <div class="col-md-2 mt-2 mb-2">--}}
{{--                           <button style="width: 100%;"  class="btn btn-primary">Postpone</button>--}}
{{--                       </div>--}}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row" class="overflow-auto">
                            <div class="col-md-12">
                                <div class="widget-content widget-content-area">
                                    <form method="POST" id="noteEditForm" action="{{route('moderator.updateCustomerNotes')}}">@csrf
                                    <b>Note</b>
        ...
        <div class="modal " id="clarifyModal" tabindex="-1" role="dialog" aria-labelledby="clarifyModal" aria-hidden="true">

            <div class="modal-dialog modal-xl" role="document">
                <!-- Modal content-->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Clarify to Customer</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="row" class="overflow-auto">
                            <div class="col-md-12">
                                <div class="widget-content widget-content-area">
                                    <p> Please review your answer and confirm you meet the criteria for the answer. </p>
                                    <textarea class="form-control" style="width: 100%;height: 150px;" id="clarifyPreviewArea"></textarea>
                                    <div class="col-md-12">
                                        <input id="clarifyTerms" type="checkbox"> <label><p>I give affirmation to the requirement and criteria.</p></label>
                                    </div>
                    ...
                    <div class="modal-footer md-button">
                        <button class="btn btn-primary" id="clarifyCustomer">Clarify</button>
                                               ...
                                               <table class="table" >
                                                   @foreach($ques->questions as $q)
                                                       <tr style="border: 1px solid black">
                                                             ...
                                                             <td class="col-md-10" id="copy-{{$q->id}}" ><p align="justify">{{$q->question}}</p></td>
                                                           <td  class="col-md-2" style="text-align: right"><button onclick="myFunction('copy-{{$q->id}}')" class="btn btn-primary">Use Template</button></td>
...
@section('pagespecificscripts')
    ...
    <script>
        ...
        var rating = $(this).val();
        var chatId = $("input[name=astro_query_id]").val();
        var moderatorId =$("input[name=moderator_id]").val();
        var astrologerId =$("input[name=astrologer_id]").val();
        let _token   = $('meta[name="csrf-token"]').attr('content');
        $.ajax({
            url: "/moderator/rateAstrologer",
            type:"POST",
            data:{
            rating:rating,
            query_id: chatId,
    ...
    <script>
    $('#answerAsPyschologist').click(function (event) {

        if ($('#current').text() > 650) {
            var app = <?php echo json_encode($restrictedWords); ?>;
            ...
            for (var i = 0; i < words.length; ++i) {
                for(var j=0; j < app.length; ++j){
                    if(words[i].toLowerCase() === app[j]['word'].toLowerCase()) {
                        error = error + 1;
                        break;
                    }
                }
            ...
            if (error > 0) {
                toastr.warning('You have entered some restricted words.')
                ...
                var randomItem = greetings[rand][0];
                var randomIdentifier = greetings[rand][1];
                document.getElementById("messagePreviewAreaPsychologist").value = randomItem + names[0] + randomIdentifier + " " + message;


                $("#answerAsPsychologistModal").modal("show");
    ...
    <script>
        $('#answerPreviewButton').click(function (event) {
            if ($('#current').text() > 650) {
                ...
                //     var val = (app[i]['word']).trim();
                //
                //     if ((message.toLowerCase()).includes(val.toString())) {
                ...
                if (error > 0) {
                    ...
                    document.getElementById("messagePreviewArea").value = randomItem + names[0] + randomIdentifier + " " + message;
    ...
    <script>
        $("#clarifyCustomer").click(function (event){
            event.preventDefault();
            $('#clarifyCustomer').prop('disabled', true);
            if ($('#clarifyTerms').is(':checked')){
                var moderatorId =$("input[name=moderator_id]").val();
                let _token   = $('meta[name="csrf-token"]').attr('content');
                var chatId = $("input[name=chat_id]").val();
                var customerId = $("input[name=customer_id]").val();
                var copyText = document.getElementById('clarifyPreviewArea').value;
                $.ajax({
                    url: "/moderator/clarifyQuestionToCustomer",
                    type:"POST",
                    data:{
                        message:copyText,
                        chat_id:chatId,
                    ...
                    success:function(response){
                        ...
                        if(response.success) {
                            ...
                            window.location.replace('{{route('moderator.dashboard')}}');
                            toastr.success('Successfully clarified.') ;
                        }
                    },
                });
            }
            else{
                toastr.warning('Please Accept Terms and Condition') ;
            }
        });
    ...
    <script>
        function myFunction(id) {
            ...
            $('.modal').modal('hide');
            // document.getElementById('answerAsPyschologistArea').style.display='none';
            var sendPyshoArea = document.getElementById('answerAsPyschologistArea');
            if(sendPyshoArea){
                sendPyshoArea.style.display='none';
            }
            var sendAstroArea = document.getElementById('sendToAstrologerArea');
            if(sendAstroArea){
                sendAstroArea.style.display='none';
            }
            var sendCustomerArea = document.getElementById('answerToCustomerArea');
            if(sendCustomerArea){
                sendCustomerArea.style.display='none';
            }

            var clarifyBtnArea = document.getElementById('clarifyBtnArea');
            if(clarifyBtnArea){
                clarifyBtnArea.style.display='block';
            }

            var cancelBtnArea = document.getElementById('cancelBtnArea');
            if(cancelBtnArea){
    ...
    <script type="text/javascript">
                $("#backToAstrologer").click(function (event) {
                    $('#backToAstrologer').prop('disabled', true);
                    event.preventDefault();
                    var message = document.getElementById("messageArea").value;
                    var revertedQueryId = $("input[name=reverted_id]").val();
                    var chat_id = $("input[name=chat_id]").val();
                    let _token   = $('meta[name="csrf-token"]').attr('content');

                    $.ajax({
                        url: "/moderator/backToAstrologer",
                        type:"POST",
                        data:{
    ...
    <script>
        $("#cancelBtn").click(function (event){
            ...
            var sendPyshoArea = document.getElementById('answerAsPyschologistArea');
            if(sendPyshoArea){
                sendPyshoArea.style.display='block';
            }
            var sendAstroArea = document.getElementById('sendToAstrologerArea');
            if(sendAstroArea){
                sendAstroArea.style.display='block';
            }
            var sendCustomerArea = document.getElementById('answerToCustomerArea');
            if(sendCustomerArea){
                sendCustomerArea.style.display='block';
            }

            var clarifyBtnArea = document.getElementById('clarifyBtnArea');
            if(clarifyBtnArea){
                clarifyBtnArea.style.display='none';
            }
        ...
        $("#clarifyBtn").click(function (event){
            event.preventDefault();
            var message = document.getElementById("messageArea").value;
            if(message.includes('@')){
                toastr.error('Clarification contains @.') ;
                ...
                var randomIdentifier = greetings[rand][1];
                console.log(randomItem);
                document.getElementById("clarifyPreviewArea").value = randomItem + names[0] + randomIdentifier + " " + message;
                $("#clarifyModal").modal("show");
                $('#clarifyCustomer').prop('disabled', true);
                setTimeout(function () {
                    $('#clarifyCustomer').prop('disabled', false);
                }, 5000);
            }
    ...
    $("#sendToAstrologer").click(function (event){
        ...
        $.ajax({
            url: "/moderator/sendQuerytoAstrologer",
            type:"POST",
            data:{
                message:message,
                chat_id:chatId,
...
{{--    <script>--}}
{{--        $("#sendToPsychologist").click(function (event){--}}
{{--            event.preventDefault();--}}
...
{{--            let _token   = $('meta[name="csrf-token"]').attr('content');--}}
{{--            $.ajax({--}}
{{--                url: "/moderator/sendQuerytoPsychologist",--}}
{{--                type:"POST",--}}
{{--                data:{--}}
{{--                    message:message,--}}
{{--                    chat_id:chatId,--}}
...
{{--    </script>--}}
    ...
    let _token   = $('meta[name="csrf-token"]').attr('content');
    $.ajax({
    url: "/moderator/storeCustomerNotes",
    type:"POST",
    data:{
    notes:notes,
    customer_id: customerId,
    ...
    <script>
        $("#sendPsychologistAnswerToCustomer").click(function (event){
            event.preventDefault();

            if ($('#confirmAsPyschologist').is(':checked')){
                $('#sendPsychologistAnswerToCustomer').prop('disabled', true);
                var message = document.getElementById("messagePreviewAreaPsychologist").value;
                ...
                let _token   = $('meta[name="csrf-token"]').attr('content');
                $.ajax({
                    url: "/moderator/sendAnswerToCustomerAsPsychologist",
                    type:"POST",
                    data:{
                    ...
                    success:function(response){
                        console.log(response);
                        if(response.success) {
                            $("#answerAsPsychologistModal").modal("hide");
                ...
                toastr.warning('Please acceept terms and conditions');
            }
    ...
    event.preventDefault();
        ...
        if ($('#termsCondition').is(':checked')){
            ...
            let _token   = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: "/moderator/sendAnswerToCustomer",
                type:"POST",
                ...
                success:function(response){
                    ...
                    if(response.success) {
                        $("#answerModal").modal("hide");
                        window.location.replace('{{URL('moderator/dashboard')}}');
                        toastr.success(response.success);
