                            ...
                            <table id="zero-config" class="table table-hover" style="width:100%">
                                ...
                                @foreach($categories as $cat)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{URL::to('admin/question/questionModCategory/edit/'.$cat->id)}}">
                                            ...
                                            <a href="{{URL::to('admin/question/questionModCategory/delete/'.$cat->id)}}">
        ...
        <div class="col-lg-4 col-4 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    @if(isset($category))
                        <form action="{{route('admin.updateCategoryModerator',$category->id)}}" method="POST" enctype="multipart/form-data">@csrf

                    @else
                        <form action="{{route('admin.storeCategoryModerator')}}" method="POST" enctype="multipart/form-data">@csrf
