    ...
    <div class="row layout-top-spacing">
                ...
                <div id="accordionBasic" class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Sample Question [Moderator] </h4>
                        </div>
                    </div>
                </div>
                                            ...
                                            <table  class="table table-hover" style="width:100%">
                                                ...
                                                @foreach($ques->questions as $q)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{URL::to('admin/question/moderator/edit/'.$q->id)}}">
                                                            ...
                                                            <a href="{{URL::to('admin/question/moderator/delete/'.$q->id)}}" id="deleteQuestion">
        ...
        <div class="col-lg-4 col-4 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    @if(isset($ques_edit))
                        <form action="{{route('admin.updateMQuestionSample',$ques_edit->id)}}" method="POST" enctype="multipart/form-data">@csrf

                    @else
                        <form action="{{route('admin.storeMQuestionSample')}}" method="POST" enctype="multipart/form-data">@csrf

                    @endif
                        <div class="form-group mb-4">
                            <label for="exampleFormControlInput2">Question</label>
                            <input type="text" class="form-control" value="{{@$ques_edit->question}}" name="question" id="exampleFormControlInput2" placeholder="Enter Question..">
                        </div>
                        <div class="form-group mb-4">
