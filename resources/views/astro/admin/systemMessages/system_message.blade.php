...
{{--                                    <th class="no-content"></th>--}}
                                ...
                                @foreach($system_messages as $message)
                                    <tr>
                                        ...
                                        <td>{{$message->country}} | {{$message->vedic_sign}} | {{$message->customers}} </td>
        ...
        <div class="col-lg-4 col-4 layout-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    ...
                    <form action="{{route('admin.sendSystemMessage')}}" method="POST" enctype="multipart/form-data">@csrf
                        <div class="form-group mb-4">
                            <label for="exampleFormControlInput2">Title</label>
                            <input type="text" class="form-control" name="message_title" id="exampleFormControlInput2" placeholder="Enter Name..">
                        </div>
                        <div class="form-group mb-4">
                        </div>
                        <div class="form-group mb-4">
                            ...
                            <select class="form-control" id="country" name="country">
                                <option value="default">Send to all</option>
                        ...
                        <div class="form-group mb-4">
                            <label for="exampleFormControlInput2">Vedic Sign</label>
                                <select class="form-control selectpicker" name="vedic_sign" >
                                    ...
                                    <option value="Dhanur"> Dhanur</option>
                        ...
                        <div class="form-group mb-4">
                            <label for="exampleFormControlInput2">Customer Type</label>
                            <select class="form-control selectpicker" name="customer_type" >
                                <option value="default">Send to all</option>
                        ...
                        <div class="form-group mb-4">
                            <label for="exampleFormControlInput2">Message Text</label>
                            <textarea class="form-control" name="message_text" id="exampleFormControlInput2" placeholder="Enter Description.."></textarea>
                        </div>
                        <div class="form-group mb-4" style="text-align: center">
                            <input type="submit" class="btn btn-primary" value="Send to Customers">
                        </div>
