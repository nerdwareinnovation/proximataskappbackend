        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
               <div class="col-md-12">
                   ...
                   <div class="offset-2">
                       <form method="POST" enctype="multipart/form-data" action="{{route('admin.filterCustomer')}}">@csrf
                       <div class="row">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Assign Question</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="POST" id="modalContentAssignForm" >@csrf

                <div class="modal-body" id="modalContentAssign">
                        <label>Questions Available</label>
                        <input type="text" name="question_left" id="questionavailable_assign" class="form-control">
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#zero-config').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: "{{route('admin.getCustomerList')}}",
                    data: function(data){
        ...
        function updateQuestion(userid,availableQuestions){
            $('#questionavailable_assign').val(availableQuestions);
                 em_action = '/admin/updateAvailableQuestion/'+userid;
            console.log(em_action);
                $('#modalContentAssignForm').attr('action',em_action);
