<div class="widget widget-four">
    <div class="widget-heading">
        <h5>Astrologer Name: {{$astrologer_name}}</h5>
                ...
                <div class="summery-info">
                    ...
                    <div class="w-summary-details">
                        ...
                        <div class="w-summary-info">
                            <h6>Questions Answered <span class="summary-count">{{$questions_answered}}</span></h6>
            ...
            <div class="summary-list summary-profit">
                ...
                <div class="summery-info">
                    ...
                    <div class="w-summary-details">
                        ...
                        <div class="w-summary-info">
                            <h6>Question Postponed <span class="summary-count">{{$questions_postponed}}</span></h6>
            ...
            <div class="widget-content widget-content-area">
                ...
                <div class="card component-card_7">
                    <div class="card-body">
                        ...
                        <h6 class="rating-count">{{$rating}}</h6>
